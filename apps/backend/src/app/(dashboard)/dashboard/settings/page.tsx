...
export default function SettingsPage() {
  ...
  type SettingsSection = "company" | "branding" | "banking" | "footer";
  ...
  if (!userPending && user && user.role !== "admin") {
    return (
      <div className="mx-auto max-w-xl">
        <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
          ...
          <p className="mb-4 text-sm text-slate-600">
            Only administrators can view and update company settings. If you think this is a mistake, contact your admin.
          </p>
          <button
            type="button"
  ...
  return (
    <div className="mx-auto max-w-xl space-y-4">
      <div className="app-card p-6">
        ...
        {!canEdit && isAdmin && (
          <div className="mb-4 app-alert-warning">
            Your subscription is inactive, so settings are read-only. Renew to edit company details.
          </div>
        )}
        <div className="mb-4 inline-flex rounded-lg bg-slate-100 p-1 text-xs">
          {[
            ...
            <button
              ...
              className={`min-w-[96px] rounded-md px-3 py-1.5 font-medium transition ${
                activeSection === section.id
                  ? "bg-white text-slate-900 shadow-sm"
                  : "text-slate-600 hover:bg-slate-100-hover"
              }`}
            >
              {section.label}
            </button>
              ...
              <div className="grid gap-4">
                <div>
                  ...
                  <input
                    ...
                    required
                    disabled={!canEdit}
                    className="w-full rounded border border-slate-200 px-3 py-2 text-sm disabled:bg-gray-100 disabled:text-gray-500"
                  />
                </div>
                <div>
                  <label className="mb-1 block text-sm font-medium text-slate-600">
